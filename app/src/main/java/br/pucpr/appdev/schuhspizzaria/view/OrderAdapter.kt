...
import br.pucpr.appdev.schuhspizzaria.databinding.ItemHomepageBinding
...
class OrderAdapter(var orders: MutableList<Order>) : RecyclerView.Adapter<OrderAdapter.OrderHolder>() {
    ...
    inner class OrderHolder(var binding: ItemHomepageBinding) : RecyclerView.ViewHolder(binding.root)
}